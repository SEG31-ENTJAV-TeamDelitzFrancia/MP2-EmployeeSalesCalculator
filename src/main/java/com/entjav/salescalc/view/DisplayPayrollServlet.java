...
/** 
 * Servlet that only handles printing of payroll from calculations done by previous
 * servlet (SalesCalcServlet)
 * */
public class DisplayPayrollServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException {
		...
		if (req.getAttribute("employeeData") != null) {
			EmployeeBean employee = (EmployeeBean) req.getAttribute("employeeData");
